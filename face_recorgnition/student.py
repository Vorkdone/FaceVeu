...
class Student:
    def __init__(self, root):
        ...
        dep_combo=ttk.Combobox(current_cours_frame,font=("logan",12,"bold"),width=15,state="read only") 
        ...
        year_combo=ttk.Combobox(current_cours_frame,font=("logan",12,"bold"),width=15,state="read only") 
        ...
        course_combo=ttk.Combobox(current_cours_frame,font=("logan",12,"bold"),width=15,state="read only") 
        ...
        semister_combo=ttk.Combobox(current_cours_frame,font=("logan",12,"bold"),width=15,state="read only") 
        ...
        studentID_entry=ttk.Entry(class_student_frame,width=15,font=("logan",12,"bold"))     
        ...
        academic_year_entry=ttk.Entry(class_student_frame,width=15,font=("logan",12,"bold"))     
        ...
        studentName_entry=ttk.Entry(class_student_frame,width=15,font=("logan",12,"bold"))     
        ...
        class_division_entry=ttk.Entry(class_student_frame,width=15,font=("logan",12,"bold"))     
        ...
        Roll_no_entry=ttk.Entry(class_student_frame,width=15,font=("logan",12,"bold"))     
        ...
        Gender_entry=ttk.Entry(class_student_frame,width=15,font=("logan",12,"bold"))     
        ...
        DOB_entry=ttk.Entry(class_student_frame,width=15,font=("logan",12,"bold"))     
        ...
        Email_entry=ttk.Entry(class_student_frame,width=15,font=("logan",12,"bold"))     
        ...
        Address_entry=ttk.Entry(class_student_frame,width=15,font=("logan",12,"bold"))     
        ...
        Phone_No_entry=ttk.Entry(class_student_frame,width=15,font=("logan",12,"bold"))     
        ...
        # button 1
        Save_bth=Button(btn_frame,text="Save",width=13,font=("logan",12,"bold"),bg="blue",fg="white")
